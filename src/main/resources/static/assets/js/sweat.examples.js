(function($){
	...
	if ($basic_swal.length > 0 ) {
		$basic_swal.on("click", function(e){
            swal("Verification mail send.", " Please check your mail and follow instructions for registrations", "success");
            e.preventDefault();
		});
	}
	...
	if ($swal_success.length > 0 ) {
		$swal_success.on("click", function(e){
            swal("Verification mail send.", " Please check your mail for confirmation code.\n Code is valid 3 minutes.", "success");
            e.preventDefault();
		});
	}
